          ...
          child: Column(
            ...
            children: [
              _TopSection(
                ...
                onOpenReading: () => _showNavigatingSnack('explorer'),
              ),
              ...
              GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final emoji = storyNumber <= 6
                      ...
                      : genericEmojis[(storyNumber - 7) % genericEmojis.length];
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Row(
          children: [
            _BackButtonPill(onBack: onBack, levelId: 1, levelName: 'Explorer'),
            const Spacer(),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppColors.gradientSoft.withValues(alpha: 0.98),
